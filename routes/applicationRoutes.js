...
import { protectAgent, protect as adminProtect } from '../middleware/auth.js';
...
// AGENT ROUTES
// ============================================
router.get('/dropdowns/universities', protectAgent, getUniversities);
router.get('/dropdowns/programs/:universityId', protectAgent, getProgramsByUniversity);
router.post('/applications', protectAgent, applicationUpload, createApplication);
router.get('/applications/stats', protectAgent, getApplicationStats);
router.get('/applications', protectAgent, getMyApplications);
router.get('/applications/:id', protectAgent, getApplicationById);
router.put('/applications/:id', protectAgent, applicationUpload, updateApplication);
router.delete('/applications/:id', protectAgent, deleteApplication);
